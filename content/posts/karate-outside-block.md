---
title: "Karate: Outside Block"
date: 2025-01-08T09:00:00-05:00
slug: karate-outside-block
tags:
  - "karate"
  - "technique"
  - "orange belt"
...
3. **Execute the Outside Block:**
   - From the chambered position, move your right forearm horizontally across your body to the right, aiming to intercept an incoming attack.
   - The motion should be fluid, with the forearm traveling from the inside outward, ending with the fist near your right shoulder.
   - Keep your shoulders relaxed and maintain a strong, stable stance throughout the movement.

4. **Recoil and Return to Guard:**
...
- **Practice:** Regularly practice the outside block to develop muscle memory, fluidity, and effective defense.

## Recommended Video:

For a visual demonstration and further guidance, you might find this tutorial helpful:

<iframe width="560" height="315" src="https://youtube.com/embed/Qv8FX0HqNdc" title="Outside block (Soto Uke)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
